        ...
        [
          {
            ...
            config: {
              type: 'SelectControl',
              label: t('Badge color'),
              default: 'green-tilleul-verveine',
              choices: [
                // [value, label]
        ...
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              // ^ this makes it apply instantaneously, without triggering a "run query" button
              label: t('Card image src'),
              description: t('Card image src'),
            },
          },
        ],
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              // ^ this makes it apply instantaneously, without triggering a "run query" button
              label: t('Card image alt'),
              description: t('Card image alt'),
            },
          },
        ],
        [
        ...
        [
          {
            ...
            config: {
              ...
              choices: [
                ...
                ['horizontal_t', 'horizontal (tier)'],
                ['horizontal_h', 'horizontal (half)'],
                ['vertical', 'vertical'],
              ],
